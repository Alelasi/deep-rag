...
使用：
  python full_computer_rag.py index --dir "D:\文档\ai提问相关"
  python full_computer_rag.py search "INTJ的主导功能是什么"
"""
import os
import sys
...
class FullComputerRAG:
    """全电脑 RAG 系统"""

    def __init__(
        self,
        db_path: str = "data/full_computer_rag",
